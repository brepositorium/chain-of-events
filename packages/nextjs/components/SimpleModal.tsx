...
import { scheduleMintLimitUpdate, schedulePause, schedulePriceUpdate, transferExtra } from '~~/utils/chain-of-events/deployContract';
            ...
            <div className="modal-box bg-base-300">
                ...
                <form onSubmit={handleSubmit}>
                    <h3 className="font-bold text-lg">{
                                        ...
                                        : fieldName === 'mintLimit' ? 'Edit mint limit'
                                        : fieldName.includes('schedule') ? 'Schedule update'
                                        : `Edit ${fieldName}`}
                                        </h3>
                            ...
                            <div className="flex flex-col gap-4 mt-8">
                                ...
                                className='input input-md input-bordered w-80 bg-base-content rounded text-black'
                                />
                                <select value={timezone} onChange={(e) => setTimezone(e.target.value)} className="select bg-base-content text-black rounded w-80 select-bordered">
                            ...
                            : <div className="mt-8">
                                <input
                                    type={
                                        fieldName === 'numberOfTickets' || fieldName === 'price' || fieldName === 'mintLimit' || fieldName === 'schedulePause' ? "number" 
                                    ...
                                    placeholder={
                                        ...
                                        : fieldName === 'mintLimit' ? 'Enter new mint limit'
                                        : fieldName === 'schedulePause' ? 'Update time'
                                        : `Enter new ${fieldName}`}
                                    value={inputValue}
                                    onChange={e => setInputValue(e.target.value)}
                                    className="input input-md input-bordered w-80 bg-base-content rounded text-black"
