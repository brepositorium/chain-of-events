  ...
  return (
    <div className="h-[650px] bg-spirals bg-no-repeat">
        <div className="flex flex-col gap-4 mt-12 items-center p-6 max-w-2xl mx-auto bg-gradient-to-b from-secondary via-primary to-secondary ... rounded-xl shadow-md space-x-4">
            <div className="text-xl font-outfit mb-8">Extra's address: <span className="font-extrabold">{address}</span></div>
            <button className="btn btn-gradient-primary rounded btn-md w-32" onClick={() => handleEditClick('createdEvent_price')}>Change price</button>
            <button className="btn btn-gradient-primary rounded btn-md w-32" onClick={() => handleEditClick('createdEvent_mintLimit')}>Change Mint Limit</button>
            <button className="btn btn-gradient-primary rounded btn-md w-32" disabled={isPaused} onClick={handlePause}>Pause</button>
            <button className="btn btn-gradient-primary rounded btn-md w-32" disabled={!isPaused} onClick={handleUnpause}>Unpause</button>
            <div className="mt-8 divider"></div>
            <ChainlinkContractManager 
            extraAddress={address} 
            onScheduleButtonClick={handleEditClick}
            />
