  ...
  return (
    <div className="h-[650px] bg-circles bg-no-repeat">
      <div className="flex flex-col items-center mt-12 gap-4">
        ...
        <div className="text-lg w-96 border p-2">
            {dataEvents.eventCreateds[0].createdEvent_location}
        </div>
      </div>
      <div className="flex my-8 justify-center">
        <Link href={"/shop/" + id + "/0"} className="btn btn-gradient-primary rounded ml-8">Buy ticket</Link>
        <Link href={"/shop/" + id + "/1"} className="btn btn-gradient-primary rounded ml-8">Buy drink/snack</Link>
      </div>
